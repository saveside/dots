...
mkdir -p ~/.fonts
wget https://files.xeome.dev/sf-pro.zip && unzip sf-pro.zip -d ~/.fonts
...
fc-cache -frv
rm -f monaspace-v1.000.zip sf-pro.zip
```
...
| Super + Q              | Launch web browser (`helium-browser`)|
